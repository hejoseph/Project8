...
//    }
    ...
    @RequestMapping("/getVisitedLocation")
    public String getVisitedLocation(@RequestParam String uuid) {
//        System.out.println(UUID.randomUUID().toString());
        UUID num = UUID.fromString(uuid);
        VisitedLocation location = gpsUtilCustom.getUserLocation(num);
        return JsonStream.serialize(location);
    }
